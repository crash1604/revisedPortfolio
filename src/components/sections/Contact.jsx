...
const Contact = () => {
  return (
    ...
    <div className="flex flex-col sm:flex-row justify-between border-b mt-4 mx-4 px-4 max-w-screen-lg">
        <div className="flex flex-col items-center justify-evenly bg-indigo-200 rounded-lg overflow-hidden shadow-lg p-6 mb-4 sm:mb-0">
        <div className='flex'>
            <a href="" className="text-black hover:text-blue-700">
            <svg viewBox="0 0 512 512" preserveAspectRatio="xMidYMid meet" className="w-10 h-10 md:w-16 md:h-16" fill="currentColor">
