...
<div className="container mx-auto p-4 relative">
      <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl z-10 relative">Contact Me</h2>
      <ConcentricCircles className="justify-center absolute inset-0 w-full h-full" />

      {/* This div is absolutely positioned and overlayed on top of the concentric circles */}
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="flex items-center justify-evenly bg-indigo-200 rounded-lg overflow-hidden shadow-lg p-6 mb-4 sm:mb-0 w-full md:max-w-2xl">
          {/* Icons and links */}
          <a href="https://linkedin.com" className="text-black hover:text-blue-700">
            {/* LinkedIn Icon */}
          </a>
          <a href="mailto:your@email.com" className="text-black hover:text-red-700">
            {/* Mail Icon */}
          </a>
          <a href="https://github.com" className="text-black hover:text-green-500">
            {/* GitHub Icon */}
          </a>
        </div>
      </div>
