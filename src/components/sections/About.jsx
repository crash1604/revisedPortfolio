          ...
          <div className="flex flex-wrap items-center justify-between -mx-4">
            <div className="w-full px-4 lg:w-6/12">
              <div className="flex items-center -mx-3 sm:-mx-4">
                ...
                <div className="w-full px-3 sm:px-4 xl:w-1/2">
                  <div className="relative z-7 my-4">
                    <img
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div className="mt-10 lg:mt-0 bg-indigo-200 rounded-lg p-5">
                ...
                a Software Engineer proficient in solving varied challenges across industries.
                I specialize in crafting comprehensive solutions tailored to specific needs.
                </p>
                <a
